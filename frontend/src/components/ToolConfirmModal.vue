    ...
    <div class="bg-bg-card border border-border rounded-2xl w-[480px] overflow-hidden shadow-xl">
      ...
      <div class="flex items-center gap-4 px-6 py-5 border-b border-border">
        ...
        <div class="flex flex-col gap-0.5">
          <h3 class="font-heading text-lg font-semibold text-text-primary">{{ $t('toolConfirm.title') }}</h3>
          <p class="text-[13px] text-text-secondary">{{ $t('toolConfirm.subtitle') }}</p>
        </div>
      </div>
      ...
      <div class="px-6 py-5 flex flex-col gap-4">
        <div class="bg-bg-subtle border border-border rounded-lg p-4 flex flex-col gap-2">
          <span class="text-[11px] font-medium text-text-secondary uppercase tracking-wider">{{ $t('toolConfirm.tool') }}</span>
          ...
          <span class="text-[11px] font-medium text-text-secondary uppercase tracking-wider mt-2">{{ $t('toolConfirm.params') }}</span>
